...
public final class MoinsU extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
  ...
  private static MoinsU gomProto = new MoinsU();
  ...
  public static MoinsU make(libredragon.model.expressionapi.term.types.Expr _e) {

    // use the proto as a model
    gomProto.initHashCode( _e);
    return (MoinsU) factory.build(gomProto);
   ...
   *
   * @param  _e
   * @param hashCode hashCode of MoinsU
   */
