...
public final class Epsilon extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Epsilon";


  private Epsilon() {}
  private static int hashCode = hashFunction();
  private static Epsilon gomProto = (Epsilon) factory.build(new Epsilon());
  
  /**
   * Constructor that builds a term rooted by Epsilon
   *
   * @return a term rooted by Epsilon
   */

  public static Epsilon make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Epsilon and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Epsilon
   */
  @Override
