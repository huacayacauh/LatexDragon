...
public final class Eq extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
  ...
  private static Eq gomProto = new Eq();
  ...
  public static Eq make(libredragon.model.expressionapi.term.types.Expr _e1, libredragon.model.expressionapi.term.types.Expr _e2) {

    // use the proto as a model
    gomProto.initHashCode( _e1,  _e2);
    return (Eq) factory.build(gomProto);
