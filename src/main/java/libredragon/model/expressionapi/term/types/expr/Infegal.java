...
public final class Infegal extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
  ...
  private static Infegal gomProto = new Infegal();
  ...
  public static Infegal make(libredragon.model.expressionapi.term.types.Expr _e1, libredragon.model.expressionapi.term.types.Expr _e2) {

    // use the proto as a model
    gomProto.initHashCode( _e1,  _e2);
    return (Infegal) factory.build(gomProto);
   ...
   * @param  _e1
   * @param _e2
   * @param hashCode hashCode of Infegal
   */
