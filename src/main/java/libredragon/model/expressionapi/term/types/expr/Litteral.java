...
public final class Litteral extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
 ...
 //shared.SharedObject
   ...
   */
  @Override
  public libredragon.model.expressionapi.term.types.Expr setname(String set_arg) {
    return make(set_arg);
  }
...
convertATermToString(appl.getArgument(0), atConv)
  ...
  /**
    ...
    */
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<String>,tom.library.enumerator.Enumeration<libredragon.model.expressionapi.term.types.Expr>> funMake() {
    return 
        new tom.library.enumerator.F<tom.library.enumerator.Enumeration<String>,tom.library.enumerator.Enumeration<libredragon.model.expressionapi.term.types.Expr>>() {
          public tom.library.enumerator.Enumeration<libredragon.model.expressionapi.term.types.Expr> apply(final tom.library.enumerator.Enumeration<String> t1) {
            return tom.library.enumerator.Enumeration.apply(tom.library.enumerator.Enumeration.singleton((tom.library.enumerator.F<String,libredragon.model.expressionapi.term.types.Expr>) 
        new tom.library.enumerator.F<String,libredragon.model.expressionapi.term.types.Expr>() {
          public libredragon.model.expressionapi.term.types.Expr apply(final String t1) {
            return make(t1);
          }
        }),t1).pay();
          }
