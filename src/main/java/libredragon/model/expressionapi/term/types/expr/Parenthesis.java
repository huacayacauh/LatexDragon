...
public final class Parenthesis extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
  ...
  private static Parenthesis gomProto = new Parenthesis();
  ...
  public static Parenthesis make(libredragon.model.expressionapi.term.types.Expr _e) {

    // use the proto as a model
    gomProto.initHashCode( _e);
    return (Parenthesis) factory.build(gomProto);
   ...
   *
   * @param  _e
   * @param hashCode hashCode of Parenthesis
   */
  ...
  public shared.SharedObject duplicate() {
    Parenthesis clone = new Parenthesis();
  ...
  public int compareToLPO(Object o) {
    ...
    Parenthesis tco = (Parenthesis) ao;
 ...
 //shared.SharedObject
  ...
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Parenthesis) {
      ...
      Parenthesis peer = (Parenthesis) obj;
