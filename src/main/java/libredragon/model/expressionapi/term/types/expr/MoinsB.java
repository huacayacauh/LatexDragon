...
public final class MoinsB extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
  
  private static String symbolName = "MoinsB";


  private MoinsB() {}
  private int hashCode;
  private static MoinsB gomProto = new MoinsB();
    private libredragon.model.expressionapi.term.types.Expr _e1;
  private libredragon.model.expressionapi.term.types.Expr _e2;

  /**
   * Constructor that builds a term rooted by MoinsB
   *
   * @return a term rooted by MoinsB
   */

  public static MoinsB make(libredragon.model.expressionapi.term.types.Expr _e1, libredragon.model.expressionapi.term.types.Expr _e2) {

    // use the proto as a model
    gomProto.initHashCode( _e1,  _e2);
    return (MoinsB) factory.build(gomProto);
   ...
   * @param  _e1
   * @param _e2
   * @param hashCode hashCode of MoinsB
   */
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a MoinsB and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof MoinsB) {

      MoinsB peer = (MoinsB) obj;
   ...
   *
   * @return true, because this is rooted by MoinsB
   */
  @Override
