...
public final class Power extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
  ...
  private static Power gomProto = new Power();
  ...
  public static Power make(libredragon.model.expressionapi.term.types.Expr _e1, libredragon.model.expressionapi.term.types.Expr _e2) {

    // use the proto as a model
    gomProto.initHashCode( _e1,  _e2);
    return (Power) factory.build(gomProto);
   ...
   * @param  _e1
   * @param _e2
   * @param hashCode hashCode of Power
   */
