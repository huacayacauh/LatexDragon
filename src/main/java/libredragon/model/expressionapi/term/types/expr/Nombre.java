...
public final class Nombre extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
  ...
  public static Nombre make(int _i) {
 ...
 //shared.SharedObject
   ...
   */
  @Override
  public libredragon.model.expressionapi.term.types.Expr seti(int set_arg) {
    return make(set_arg);
  }
...
convertATermToInt(appl.getArgument(0), atConv)
  ...
  /**
    ...
    */
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<java.lang.Integer>,tom.library.enumerator.Enumeration<libredragon.model.expressionapi.term.types.Expr>> funMake() {
    return 
        new tom.library.enumerator.F<tom.library.enumerator.Enumeration<java.lang.Integer>,tom.library.enumerator.Enumeration<libredragon.model.expressionapi.term.types.Expr>>() {
          public tom.library.enumerator.Enumeration<libredragon.model.expressionapi.term.types.Expr> apply(final tom.library.enumerator.Enumeration<java.lang.Integer> t1) {
            return tom.library.enumerator.Enumeration.apply(tom.library.enumerator.Enumeration.singleton((tom.library.enumerator.F<java.lang.Integer,libredragon.model.expressionapi.term.types.Expr>) 
        new tom.library.enumerator.F<java.lang.Integer,libredragon.model.expressionapi.term.types.Expr>() {
          public libredragon.model.expressionapi.term.types.Expr apply(final java.lang.Integer t1) {
