...
public final class And extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
  ...
  private static And gomProto = new And();
  ...
  public static And make(libredragon.model.expressionapi.term.types.Expr _e1, libredragon.model.expressionapi.term.types.Expr _e2) {

    // use the proto as a model
    gomProto.initHashCode( _e1,  _e2);
    return (And) factory.build(gomProto);
