...
public final class Factorial extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
  ...
  private static Factorial gomProto = new Factorial();
  ...
  public static Factorial make(libredragon.model.expressionapi.term.types.Expr _e) {

    // use the proto as a model
    gomProto.initHashCode( _e);
    return (Factorial) factory.build(gomProto);
   ...
   *
   * @param  _e
   * @param hashCode hashCode of Factorial
   */
