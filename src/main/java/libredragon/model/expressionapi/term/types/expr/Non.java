...
public final class Non extends libredragon.model.expressionapi.term.types.Expr implements tom.library.sl.Visitable  {
  ...
  private static Non gomProto = new Non();
  ...
  public static Non make(libredragon.model.expressionapi.term.types.Expr _e) {

    // use the proto as a model
    gomProto.initHashCode( _e);
    return (Non) factory.build(gomProto);
   ...
   *
   * @param  _e
   * @param hashCode hashCode of Non
   */
